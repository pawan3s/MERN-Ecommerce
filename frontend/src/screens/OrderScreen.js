...
import ESEWA from "../image/esewa_logo.png";
  ...
  return loading ? (
    ...
    <>
      <h1 className='order-id'>
        Order <h5>{order._id}</h5>
      </h1>
      <Row>
        <Col md={8}>
          <ListGroup variant='flush'>
            <ListGroup.Item className='item-section'>
              <h2 className='item-header' style={{ color: "black" }}>
                Order Items
              </h2>
                ...
                <ListGroup variant='flush'>
                  {order.orderItems.map((item, index) => (
                    <ListGroup.Item key={index}>
                      <Row>
                        <Col md={1}>
                          <Image src={item.image} alt='photo' fluid rounded />
                        </Col>
                        <Col>
            ...
            <Row className='shipping-section'>
              <Col>
                <ListGroup.Item>
                  <h2 className='shipping' style={{ color: "black" }}>
                    Shipping Info
                  </h2>
                  <p>
              ...
              <Col>
                <ListGroup.Item>
                  <h2 className='payment' style={{ color: "black" }}>
                    Payment info
                  </h2>
                  <p>
                ...
                <ListGroup.Item>
                  ...
                  {order.paymentMethod === "PayPal" ? (
                    ...
                    <a href='https://esewa.com.np'>
                      <Button
                        className='signin-btn btn-block'
